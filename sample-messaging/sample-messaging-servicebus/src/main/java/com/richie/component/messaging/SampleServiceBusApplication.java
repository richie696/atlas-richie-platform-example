package com.richie.component.messaging;
 ...
 * @author richie696
 * @version 1.0
 * @since 2022-09-09 17:16:58
 */
@Slf4j
@EnableCaching
@SpringBootApplication(scanBasePackages = "com.richie")
public class SampleServiceBusApplication {

    public static void main(String[] args) throws UnknownHostException {
        ConfigurableApplicationContext application = SpringApplication.run(SampleServiceBusApplication.class, args);
