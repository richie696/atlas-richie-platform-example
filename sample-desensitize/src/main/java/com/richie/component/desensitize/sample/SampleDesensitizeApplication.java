package com.richie.component.desensitize.sample;
...
public class SampleDesensitizeApplication {

    public static void main(String[] args) throws UnknownHostException {
        ConfigurableApplicationContext application = SpringApplication.run(SampleDesensitizeApplication.class, args);
