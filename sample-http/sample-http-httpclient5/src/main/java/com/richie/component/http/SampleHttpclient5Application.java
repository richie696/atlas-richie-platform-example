package com.richie.component.http;
...
public class SampleHttpclient5Application {

    public static void main(String[] args) throws UnknownHostException {
        ConfigurableApplicationContext application = SpringApplication.run(SampleHttpclient5Application.class, args);
