package com.richie.component.vector.qdrant;
...
public class SampleVectorQdrantApplication {

    public static void main(String[] args) throws UnknownHostException {
        ConfigurableApplicationContext application = SpringApplication.run(SampleVectorQdrantApplication.class, args);
