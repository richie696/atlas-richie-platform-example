package com.richie.component.vector.weaviate;
...
public class SampleVectorWeaviateApplication {

    public static void main(String[] args) throws UnknownHostException {
        ConfigurableApplicationContext application = SpringApplication.run(SampleVectorWeaviateApplication.class, args);
