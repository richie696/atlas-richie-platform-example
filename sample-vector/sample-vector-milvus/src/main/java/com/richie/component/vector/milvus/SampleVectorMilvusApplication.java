package com.richie.component.vector.milvus;
...
public class SampleVectorMilvusApplication {

    public static void main(String[] args) throws UnknownHostException {
        ConfigurableApplicationContext application = SpringApplication.run(SampleVectorMilvusApplication.class, args);
