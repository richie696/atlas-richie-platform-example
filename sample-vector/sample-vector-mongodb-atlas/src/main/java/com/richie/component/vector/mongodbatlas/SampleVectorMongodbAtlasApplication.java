package com.richie.component.vector.mongodbatlas;
...
public class SampleVectorMongodbAtlasApplication {

    public static void main(String[] args) throws UnknownHostException {
        ConfigurableApplicationContext application = SpringApplication.run(SampleVectorMongodbAtlasApplication.class, args);
