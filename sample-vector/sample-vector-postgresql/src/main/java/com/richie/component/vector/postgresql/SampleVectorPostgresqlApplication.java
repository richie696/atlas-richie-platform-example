package com.richie.component.vector.postgresql;
...
public class SampleVectorPostgresqlApplication {

    public static void main(String[] args) throws UnknownHostException {
        ConfigurableApplicationContext application = SpringApplication.run(SampleVectorPostgresqlApplication.class, args);
