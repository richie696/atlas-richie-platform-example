package com.richie.component.vector.elasticsearch;
...
public class SampleVectorElasticsearchApplication {

    public static void main(String[] args) throws UnknownHostException {
        ConfigurableApplicationContext application = SpringApplication.run(SampleVectorElasticsearchApplication.class, args);
