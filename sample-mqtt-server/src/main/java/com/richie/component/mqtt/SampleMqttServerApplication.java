package com.richie.component.mqtt;
...
public class SampleMqttServerApplication {

    public static void main(String[] args) throws UnknownHostException {
        ConfigurableApplicationContext application = SpringApplication.run(SampleMqttServerApplication.class, args);
